...
Revision ID: 0447f4d89bb2
Revises: 
Create Date: 2025-09-25 12:59:07.253834
...
def upgrade() -> None:
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('search_vector', postgresql.TSVECTOR(), sa.Computed("setweight(to_tsvector('simple', coalesce(title, '')), 'A') || setweight(to_tsvector('simple', coalesce(description, '')), 'B') || setweight(to_tsvector('simple', coalesce(content, '')), 'C')", persisted=True), nullable=False),
