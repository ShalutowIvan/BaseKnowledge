...
from db import async_engine, get_async_session
from models import Base, User, UserRole  # Импортируйте ваши модели
    ...
    async def login(self, request: Request) -> bool:
        ...
        async for session in get_async_session():
            try:
                ...
                if user and user.verify_password(password) and user.user_role == UserRole.ADMIN:
