...
function ChapterCreateModal({ roadmap_id, onClose, onSuccess }) {
  ...
  const handleSubmit = async (event) => {
        ...
        try {
            const response = await API.post(
                `http://127.0.0.1:8000/chapter_create/${roadmap_id}`,
                {                 
                    title,                    
                    description,
                }                
    ...
    <div className="modal-overlay">
      ...
      <div className="modal-content">        
        ...
        <form onSubmit={handleSubmit} style={{ marginBottom: '1rem' }}>
                ...
                <label htmlFor="id_title">Заголовок главы: </label>
                <input 
