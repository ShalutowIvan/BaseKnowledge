...
function ChapterOpen() {
  ...
  const test = () => {
    console.log("элемент тут:", stages[0].title)
    stages[0].title = "Кузя"
    console.log("элемент тут:", stages[0].title)
  }
      ...
      <div className="project-section">        
        ...
        {!editModeHeader ? (
          ...
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            ...
            <span style={{ fontSize: '18px', color: '#5F9EA0' }}>Дата создания: {chapter.created_at}</span>
          </div>

          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>            
            <span style={{ fontSize: '20px', color: '#E0FFFF' }}>{chapter.title}</span>
          ...
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>            
            <span style={{ fontSize: '20px', color: '#E0FFFF' }}>{chapter.description}</span>
        ...
        <br/>
          ...
          <h1>Этапы изучения в разделе</h1>
          <button className="cancel-button" onClick={deleteChapter}>Удалить главу</button>
          </div>
          <p>______________________________________________________</p>
          
          <button className="toolbar-button" onClick={openModalClick}>Добавить этап</button>
        ...
        <br/><br/>                
          {
                ...
                : (stages?.map(stage => (
                				<div className="list-stage project-section">
                          {/*если не редактируем */}
                          {!stage.isEditing &&
                          <>                         
                          ...
                          <h3>Описание: {stage.description}</h3>                         
                          ...
                          <NavLink className={({ isActive }) => 
                                isActive ? "active" : ""
                              } key={stage.id} to={`/roadmaps/open/${chapter.roadmap_id}/chapter_open/${chapter_id}/stage_open/${stage?.id}`}>
