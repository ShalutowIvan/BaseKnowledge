...
function StageCreateModal({ chapter_id, onClose, onSuccess }) {
  ...
  const handleSubmit = async (event) => {
        ...
        try {
            const response = await API.post(
                `http://127.0.0.1:8000/stage_create/${chapter_id}`,
                {                 
                    title,                    
                    description,
                }                
    ...
    <div className="modal-overlay">
      ...
      <div className="modal-content">        
        ...
        <form onSubmit={handleSubmit} style={{ marginBottom: '1rem' }}>
                ...
                <label htmlFor="id_title">Заголовок этапа: </label>
                <input 
